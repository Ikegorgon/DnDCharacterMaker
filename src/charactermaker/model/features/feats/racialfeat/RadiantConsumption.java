...
public class RadiantConsumption extends RacialFeats{
	public RadiantConsumption() {
		super("Radiant Consumption", "Scourage Aasimar");
		this.setDescription("Starting at 3rd level, you can use your action to unleash the divine energy within yourself, causing a searing light to radiate from you, pour out of your eyes and mouth, and threaten to char you.\n" + 
