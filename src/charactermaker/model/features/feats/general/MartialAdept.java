...
public class MartialAdept extends GeneralFeats {
	public MartialAdept() {
		super("Martial Adept", "-");
		this.setDescription("You have martial training that allows you to perform special combat maneuvers. You gain the following benefits: \n" + 
