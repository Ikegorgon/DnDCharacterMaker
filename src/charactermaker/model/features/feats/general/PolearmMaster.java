...
public class PolearmMaster extends GeneralFeats {
	public PolearmMaster() {
		super("Polearm Master", "-");
		this.setDescription("You can keep your enemies at bay with reach weapons. You gain the following benefits: \n" + 
