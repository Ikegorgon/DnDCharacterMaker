...
public class Tiefling_Variant extends Races{
	private List<Skills> ability;
	private List<RacialFeats> feats;
	private List<String> proficiency;
	private int mod;
	public Tiefling_Variant() {
		super("Variant Tiefling");
		this.setAge(Age());
		...
		feats.add(new DevilsTongue());
		feats.add(new Hellfire());
		feats.add(new Winged());
		proficiency = new ArrayList<String>();
		proficiency.add("Common");
		proficiency.add("Infernal");
		proficiency.add("(Pick one Feat from Devil's Tongue, Hellfire, and Winged)");
